...
@elseif(session('cancel'))
      ...
      <div class="d-flex justify-content-end ">
          <a href="{{route('user_admin.create')}}"  class="btn text-white py-2 px-lg-4 mb-2 rounded-0 d-none d-lg-block" style="background-color:rgba(16, 133, 16, 0.578) ; border-radius: 10px;">Add<i class="fa fa-plus  ms-2" ></i></a>
      </div>
